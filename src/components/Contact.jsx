...
const Contact = () => {
  return (
    ...
    from-black to-gray-800 p-4 text-white pt-4'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form method="POST" action="https://getform.io/f/bb6065f2-8ea1-4580-9dae-9507f90dcdd5" className='flex flex-col w-full md:w-1/2'>
